...
<html lang="en">
    ...
    <body>
        ...
        <section class="py-5 border-bottom" id="quotes">
            <div class="container px-5 my-5 px-5">
                <div class="text-center mb-5">
                    <h2 class="fw-bolder">Quotes of The Day</h2>
                        ...
                        <div class="card mb-4">
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-4">
                                        <p class="mb-1">Jadilah Cendekia dunia dengan membaca Buku</p>
                                        <div class="small text-muted">- WS Rendra, Indonesia</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    <div class="flex-shrink-0"><i class="bi bi-chat-right-quote-fill text-primary fs-1"></i></div>
                                    <div class="ms-4">
                                        <p class="mb-1">Taklukan dunia dengan ilmu pengetahuan</p>
                                        <div class="small text-muted">- Kahlil Gibran, Indonesia</div>
                                    </div>
                                </div>
                            </div>
                        </div>
